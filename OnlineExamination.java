...
{  
    ...
    {  
        ...
        {  
            ...
            jb[0].setText("JDK");jb[1].setText("JRE");jb[2].setText("JVM");jb[3].setText("JIT");   
        }  
        if(current==1)  
        {  
        ...
        if(current==5)  
        {  
            l.setText("Que6: Which one of the following is not a Java feature?");  
            jb[0].setText("Object Oriented");jb[1].setText("Use of pointer");jb[2].setText("Robust");jb[3].setText("Platform independent");  
        }  
        if(current==6)  
        {  
